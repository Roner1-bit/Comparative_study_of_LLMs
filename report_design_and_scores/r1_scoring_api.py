...
client = OpenAI(
    api_key="LA-e261f84098bb4eefbe83ff573bdeb7f9a16c0caa117a45bb94475949c53b7f19",
...
model_encodings = {
    ...
    #"deepseek-vl2.txt": "Model C",  got a whole score of 0 in the metrics
...
for case in os.listdir(cases_dir):
    ...
    for model_file, model_name in model_encodings.items():
        ...
        if os.path.exists(model_response_path):
            ...
            plot_file_path = os.path.join(plot_file_path, f'{case}_{model_file.split(".")[0]}_r1-score.txt')
...
4. Medical-Images-Description: How well does the AI-generated report describe the medical images and is it really seeing it or making things up? (Score 0-10)"""
            ...
            print(f"Generated r11 response for {case} - {model_name}")
